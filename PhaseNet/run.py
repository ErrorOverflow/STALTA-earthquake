...
def memory_compute(model):
    model.summary()
    all_params_memory = 0
    all_feature_memory = 0
    for layer in model.layers:
        # 训练权重w占用的内存
        params_memory = layer.count_params() / (6000 * 3) * 4
...
def count1():
    ...
    print('trainable_variables:', total_parameters)
