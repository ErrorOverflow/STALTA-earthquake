...
def main(inp_name):
    ...
    for h5name in glob.glob('/media/wml/新加卷/地震数据集/STEAD/chunk*.hdf5'):
        ...
        for evi in dtfl['data']:
            ...
            # dsF = HDFr.create_dataset(
            #     "data/"+evi, data.shape, data=data, dtype=np.float32)
